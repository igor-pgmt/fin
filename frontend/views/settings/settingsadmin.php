...
/* @var $settings frontend\models\Settingadmin */
/* @var $form ActiveForm */
?>
<div class="settingsadmin">
	...
	<?php $form = ActiveForm::begin(); ?>
		...
		<?= $form->field($settings, 'registration')->checkbox()?>

		<?= $form->field($settings, 'timezone')->dropDownList(['Timezone', $timezoneList])?>

		<?= $form->field($settings, 'sessionUsing')->checkbox() ?>
		...
		<?= $form->field($settings, 'user_id')->checkbox() ?>
		<?= $form->field($settings, 'name_user_id')->textInput(['value'=> $settings->name_user_id ? $settings->name_user_id : $settings->getAttributeLabel('name_user_id')])->label(false); ?>
